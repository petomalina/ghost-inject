...
(function() {
  ...
  module.exports = Injector = (function() {
    ...
    Injector.prototype.addService = function(key, service) {
    ...
    Injector.prototype.create = function(Constructor, dependencyList) {
      ...
      this.inject(Constructor, instance, dependencyList);
      return instance;
    };

    Injector.prototype.call = function(func, instance, dependencyList) {
      var dependencies;
      if (dependencyList == null) {
        dependencyList = null;
      }
    ...
    Injector.prototype.inject = function(func, instance, dependencyList) {
      var dependencies;
      if (dependencyList == null) {
        dependencyList = null;
      }
    ...
    Injector.prototype.resolve = function(func, dependencyList) {
    ...
    Injector.prototype.getArguments = function(func) {
